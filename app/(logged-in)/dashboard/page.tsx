        ...
        <div className="px-2 py-12 sm:py-24">
          <div className="flex gap-4 mb-8 justify-between">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm text-rose-500 mt-5">
                Uploads used in {currentMonth}: {uploadCount} / {uploadLimit}
              </p>
          ...
          {hasReachedLimit && (
            <MotionDiv
              ...
              className="mb-6"
            >
              <div className="bg-rose-50 broder border-rose-200 rounded-lg p-4 text-rose-800">
                <p className="text-sm">
